  ...
  return (
    ...
    >
      <div style={{ height: "40px" }}>
        ...
        <Button type="primary" className="pintRight" hidden={zhiCode}>
          <Tag color="volcano"> 只码模板:</Tag>1111111
        </Button>
        <Button type="primary" className="pintRight" hidden={heCode}>
          <Tag color="volcano"> 盒码模板:</Tag>2222222
        </Button>
        <Button type="primary" className="pintRight" hidden={boxCode}>
          <Tag color="volcano"> 箱码模板:</Tag>3333333
        </Button>
      </div>
