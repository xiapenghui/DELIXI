...
import {
  ...
  addPost,
  updatePut,
} from "@/services/information/timeMaintain";

const timeMaintainComponent = ({ timeMaintain, dispatch }) => {
  const { TableList, typeList, riskList, isNoList } = timeMaintain;
...
export default connect(({ timeMaintain }) => ({ timeMaintain }))(
  timeMaintainComponent
);
