...
const printMakeCopyComponent = ({ printMake, dispatch, user, pintCode }) => {
              ...
              if (dataString.length == 1) {
                ...
                if (status == 'No') {
                  ...
                  var heRightList = content[1].replace(/[\r\n]/g, "").replace(/(.*)ADD_PRINT_BARCODE/, '$1SET_PRINT_STYLEA')
                    ...
                    .replaceAll("S标识B", materialList[1].oneLogo)
                } else {
                  //执行有防窜码
  ...
  const heCodeTest = () => {
    LodopFuncs.getLodop();
    var heList = heString
      .replace("1234567890A", "123456789012345678")
      ...
      .replace("S标识A", "S")
      .replace("1234567890B", "123456789012345678")
  ...
  const boxCodeTest = () => {
    ...
    var boxList = boxString
      .replace("1234567890", "123456789012345678")
